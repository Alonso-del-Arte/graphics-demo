...
public class TreeNGTest {
    ...
    public void testGetDimension() {
        ...
        Tree instance = new Tree(expected);
    ...
    @Test
    public void testGetDimensionFrom3ParamConstructor() {
        int width = nextInt(480, 3840);
        int height = nextInt(640, 2160);
        Dimension expected = new Dimension(width, height);
        Tree instance = new Tree(nextColor(), nextColor(), expected);
        Dimension actual = instance.getDimension();
        assertEquals(actual, expected);
    }
    ...
    @Test
    public void test3ParamConstructorRejectsDimensionWithZeroHeight() {
        int width = nextInt(256) + 1;
        int height = 0;
        Dimension size = new Dimension(width, height);
        String dimStr = size.toString();
